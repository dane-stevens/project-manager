...
export function GlobalLoading() {
	...
	return (
		<div
			...
			className="fixed inset-x-0 left-0 top-0 z-50 h-[1px] animate-pulse"
			style={{ zIndex: "99999" }}
		>
			<div
				ref={ref}
				className={cx(
					"h-full bg-linear-to-r from-blue-500 via-emerald-500 to-purple-500 transition-all duration-500 ease-in-out",
